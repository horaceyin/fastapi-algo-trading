...
from services.broker import sp_api_handler
from pyalgotrade.bar import Bars


class Strategy(strategy.BaseStrategy):
    def prod(self, prodlist):
        prod = prodlist[0]
        return prod
    ...
    def __init__(self, feed, brk):
        ...
        smaPeriod = 20
        self.__instrument = self.prod(Bars.getInstruments()) #This should be the prodcode in sp trader.
